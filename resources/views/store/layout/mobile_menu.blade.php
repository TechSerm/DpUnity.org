        ...
        <div class="cart" style="background-color: {{ $color1 }}">
                ...
                <div class="button-area" style="color: black; font-size: 11px;">
                    <a href="{{ route('store.order.list') }}">
                        <div class="mbutton {{ $firstSegment == 'order' ? 'mbuttonActive' : '' }}">
                            <img src="{{ asset('assets/img/order_icon.svg') }}" alt="menu"
                                style="width:22px;margin-bottom: 2px"><br />
                            অর্ডার
                        </div>
                    </a>
                    <a href="/categories" class="link">
                        <div class="mbutton  {{ $firstSegment == 'categories' ? 'mbuttonActive' : '' }}">
                            <img src="{{ asset('assets/img/categories_icon.svg') }}" alt="menu"
                                style="width:22px; margin-bottom: 2px"><br />
                            ক্যাটেগরি
                        </div>
                    </a>
            ...
            <div style="float-left;">
                ...
                <div class="status-area"
                    style="background: {{ $color }};  {{ $totalCart > 0 ? '' : 'opacity: 0.6;' }} width: 50%">
                    ...
                    <div
                        ...
                        <div class="amount" style="">
                            ...
                            @else
                                <img src="{{ asset('assets/img/empty_bag_2.webp') }}" style="margin-top: -2px;"
                                    height="40px" alt="">
                            @endif
                        </div>
                    </div>
