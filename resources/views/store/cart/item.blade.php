<tr style="{{ $totalQuantity <= 0 ? 'display: none' : '' }}">
    ...
    <td class="align-middle">
        ...
        <div style="font-size: 11px;font-weight: bold; color: #767575">৳ {{ convertBanglaNumber($item->price) }}  / {{ convertBanglaNumber(15) }} গ্রাম </div>
    ...
    <td class="align-middle" style="text-align: center; width: 20px;">
        <span class="badge badge-info">৳ {{ convertBanglaNumber($totalPrice) }}</span> 
    </td>
</tr>
