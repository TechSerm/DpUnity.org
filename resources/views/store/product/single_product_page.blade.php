@if (isset($searchQuery))
    <div class="col-md-12">
        <div style="text-align: center; margin-right: 10px; color: #A9A9A9; margin-bottom: 20px;padding-bottom: 15px;border-bottom: 1px solid #dbdbdb">
            অনুসন্ধান ফলাফল: <b>"{{$searchQuery}}"</b><br/>
            <div style="font-size: 10px;">
                <b>"{{$searchQuery}}"</b>  এর জন্য <b>{{bnConvert()->number($totalProducts)}}</b> টি আইটেম পাওয়া গেছে
            </div>
        </div>
