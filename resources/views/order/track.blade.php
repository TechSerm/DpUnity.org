...
<div class="form-group" id="map">
    {!! Form::label('Drag marker to set latitude and longitude', null, ['class' => 'col-sm-3 control-label']) !!}
    <div class="col-sm-3">
        <div id="myMap"></div>
    </div>
</div>
...
@push('scripts')
    <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyAom8x8f8jt8z_B_K7GRXTdD07LFP21lTI"></script>
    <script type="text/javascript">
    
        function setLatLong(mapMarker) {
            geocoder.geocode({
                'latLng': mapMarker
        ...
        var latlon = [23.766857, 90.429807];
        var mapPointer = {
        ...
        var marker;
            ...
            var myLatlng = new google.maps.LatLng(mapPointer.lat, mapPointer.lng);
        ...
        function initialize() {
            ...
            setLatLong(mapPointer);
            google.maps.event.addListener(marker, 'dragend', function() {
                setLatLong(marker.getPosition());
            });
        }
        ...
        <div class="card-body">
            ...
            <div class="track">
                <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span
                        class="text">অর্ডার গ্রহণ করা হয়েছে</span> </div>
                        <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span
                            class="text">অর্ডার গ্রহণ করা হয়েছে</span> </div>
